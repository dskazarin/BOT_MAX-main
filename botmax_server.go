...
// HTML страницы с правильной кодировкой UTF-8
...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <button class="voice-btn" onclick="alert('🎤 Голосовой ввод активирован. Скажите ваши симптомы.')">🎤 Голосовой ввод</button>
            <button class="photo-btn" onclick="alert('📸 Камера активирована. Сфотографируйте рецепт или анализ.')">📸 Загрузить фото</button>
            ...
            <button onclick="alert('✅ Симптом успешно добавлен в дневник здоровья')">➕ Добавить симптом</button>
        </div>
        <div class="card">
            <h3>💊 Мои препараты</h3>
...
<body>
    ...
    <div class="container">
        ...
        <div class="content-area">
            ...
            <button class="analysis-btn" onclick="alert('🧠 AI анализ истории болезни выполнен. Результаты отправлены.')">🧠 AI анализ истории</button>
            <button onclick="alert('💊 Рецепт сформирован и подписан электронной подписью')">💊 Сформировать рецепт</button>
            <button onclick="alert('📄 Справка сформирована. Данные из карты подтянуты автоматически.')">📄 Сформировать справку</button>
            <button onclick="alert('🩺 Осмотр сохранен. Данные добавлены в карту пациента.')">💾 Сохранить осмотр</button>
        </div>
    </div>
</body>
</html>`)
