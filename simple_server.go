...
// HTML страницы с русским текстом
...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .admin-btn{position:fixed;top:20px;right:20px;background:rgba(255,255,255,0.2);backdrop-filter:blur(10px);color:white;padding:10px 20px;border-radius:30px;text-decoration:none;font-weight:bold;z-index:1000}
        ...
        .features{background:#f8f9fa;padding:60px 20px;margin-top:60px;border-radius:20px}
        ...
        .footer{text-align:center;padding:40px;color:white;margin-top:40px}
...
<body>
    ...
    <div class="container">
        <div class="greeting">👋 Здравствуйте! Здесь вы можете вести дневник здоровья</div>
        <div class="card">
            <h3>📝 Добавить симптом</h3>
            <button class="voice-btn" onclick="alert('🎤 Голосовой ввод: скажите ваши симптомы')">🎤 Голосовой ввод</button>
            <button class="photo-btn" onclick="alert('📸 Загрузите фото рецепта или анализа')">📸 Загрузить фото</button>
...
<head>
    ...
    <style>
        *{margin:0;padding:0;box-sizing:border-box}
        ...
        .patient-item{padding:12px;border-bottom:1px solid #eee;cursor:pointer}
...
<body>
    ...
    <div class="container">
        <div class="patients-list">
            ...
            <div class="patient-item" onclick="alert('Карта пациента открыта')">
                <strong>Сидоров Алексей</strong><br>
                <small>52 года, последний визит: 18.03.2024</small>
            </div>
        </div>
        <div class="content-area">
            ...
            <h4>📊 Активные жалобы:</h4>
            <div style="margin:10px 0;padding:10px;background:#fff3cd;border-radius:8px">Головная боль (7/10) - 2 дня</div>
            <div style="margin:10px 0;padding:10px;background:#fff3cd;border-radius:8px">Температура 37.8°C - 1 день</div>
            <button class="analysis-btn" onclick="alert('🧠 AI анализ выполнен. Результаты отправлены')">🧠 AI анализ истории</button>
            <button onclick="alert('💊 Рецепт сформирован и подписан')">💊 Сформировать рецепт</button>
